...
class MyTestCase(unittest.TestCase):
    def test_something(self):
        ...
        product_history = ProductHistory([ProductHistoryUnit(1, 1, date.today()), ProductHistoryUnit(3, 6, date.today())])
        client_products = [
        ...
        self.assertEqual("2022-12-16: cost - 1; leftover - 1;\n2022-12-16: cost - 3; leftover - 6;\n",
